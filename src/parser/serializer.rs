...
pub fn serialize(expr: &Expr) -> String {
    match expr {
        ...
        Expr::Gate(gate) => match gate.name {
            ...
            GateName::I(qbit) => format!("I_{{{}}}", qbit),
            GateName::X(qbit) => format!("X_{{{}}}", qbit),
            GateName::Y(qbit) => format!("Y_{{{}}}", qbit),
            GateName::Z(qbit) => format!("Z_{{{}}}", qbit),
            GateName::S(qbit) => format!("S_{{{}}}", qbit),
            GateName::T(qbit) => format!("T_{{{}}}", qbit),
            GateName::CNOT(qbit, angle) => format!("CNOT_{{{},{}}}", angle, qbit),
            GateName::CZ(qbit, angle) => format!("CZ_{{{},{}}}", angle, qbit),
        },
